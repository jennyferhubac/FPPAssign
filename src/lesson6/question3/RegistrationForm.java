...
public class RegistrationForm extends JFrame {
	...
	public RegistrationForm() {
		...
		pnlHeader.setBounds(100, 5, 300, 40);
		...
		btnSubmit.addActionListener(evt->
		{
			...
			JOptionPane jOptionPane= new JOptionPane(source);
			if (txtFirstName.getText().isEmpty())
			{
				jOptionPane.showMessageDialog(source,txtFirstName.getName() + " Field should not be empty", "Required Field", JOptionPane.ERROR_MESSAGE);
				blnsuccesful=false;
			}
			
			if(txtLastName.getText().isEmpty())
			{
				jOptionPane.showMessageDialog(source,txtLastName.getName() + " Field should not be empty", "Required Field", JOptionPane.ERROR_MESSAGE);
				blnsuccesful=false;
			}
			
			if(txtStreet.getText().isEmpty())
			{
				jOptionPane.showMessageDialog(source,txtStreet.getName() + " Field should not be empty", "Required Field", JOptionPane.ERROR_MESSAGE);
				blnsuccesful=false;
			}
			
			if(txtCity.getText().isEmpty())
			{
				jOptionPane.showMessageDialog(source,txtCity.getName() + " Field should not be empty", "Required Field", JOptionPane.ERROR_MESSAGE);
				blnsuccesful=false;	
			}
			
			if(txtState.getText().isEmpty())
			{
				jOptionPane.showMessageDialog(source,txtState.getName() + " Field should not be empty", "Required Field", JOptionPane.ERROR_MESSAGE);
				blnsuccesful=false;	
			}
			
			if(txtCountry.getText().isEmpty())
			{
				jOptionPane.showMessageDialog(source,txtCountry.getName() + " Field should not be empty", "Required Field", JOptionPane.ERROR_MESSAGE);
				blnsuccesful=false;	
			}
			
			if(txtMessage.getText().isEmpty())
			{
				jOptionPane.showMessageDialog(source,txtMessage.getName() + " Field should not be empty", "Required Field", JOptionPane.ERROR_MESSAGE);
				blnsuccesful=false;	
			}
			
			if (rdbtnMale.isSelected() ==false && rdbtnFemale.isSelected()==false)
			{
				jOptionPane.showMessageDialog(source,"Need to select the Gender", "Required Gender", JOptionPane.ERROR_MESSAGE);
				blnsuccesful=false;
			}
			if (chckbxMorning.isSelected() ==false && chckbxMorning.isSelected()==false && chckbxEvening.isSelected()==false)
			{
				jOptionPane.showMessageDialog(source,"Need to select Suitable session", "Required session", JOptionPane.ERROR_MESSAGE);
				blnsuccesful=false;
			}
			if (blnsuccesful==true)
			{
				jOptionPane.showMessageDialog(source,"Successfully Registered", "Registration Status", JOptionPane.ERROR_MESSAGE);
